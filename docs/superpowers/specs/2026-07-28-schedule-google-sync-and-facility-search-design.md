...
best-effort mark that exact row for immediate retention without deleting it, so
an ambiguous upload result remains recoverable whether the object exists or is
missing.
